var jjtcpk = jjtcpk || {};
jjtcpk.version = 3, jjtcpk.create_url = function(t, e, r, n, a) {
    function i() {
    ...
    var m = i(),
        u = i(),
        l = 885187064159;
    u = ((u = u - u % 256 + jjtcpk.version) + m) % 2742745743359, l = (l + m) % 2742745743359;
    var s = "https://" + t + "/" + (m = c() + o(m)) + e,
        h = [(u = o(l) + o(u)) + "=" + r, c() + c() + "=" + n];
    return void 0 !== a && a.length > 0 && h.push(c() + c() + "=" + a), s + "?" + h.join("&")
}, jjtcpk.beacon = function(t, e, r, n) {
...
}, jjtcpk.load_tags = function(t, e, r, n) {
    jjtcpk.beacon(t, e, r, n);
    var a = document.getElementsByTagName("head").item(0),
        i = document.createElement("script");
    i.id = "tmx_tags_js", i.setAttribute("type", "text/javascript");
    var c = jjtcpk.create_url(t, ".js", e, r, n);
    i.setAttribute("src", c), jjtcpk.set_csp_nonce(i), a.appendChild(i)
}, jjtcpk.load_iframe_tags = function(t, e, r, n) {
    jjtcpk.beacon(t, e, r, n);
    var a = jjtcpk.create_url(t, ".htm", e, r, n),
...
}, jjtcpk.csp_nonce = null, jjtcpk.register_csp_nonce = function(t) {
    if (void 0 !== t.currentScript && null !== t.currentScript) {
        var e = t.currentScript.getAttribute("nonce");
        void 0 !== e && null !== e && "" !== e ? jjtcpk.csp_nonce = e : void 0 !== t.currentScript.nonce && null !== t.currentScript.nonce && "" !== t.currentScript.nonce && (jjtcpk.csp_nonce = t.currentScript.nonce)
    }
}, jjtcpk.set_csp_nonce = function(t) {
    null !== jjtcpk.csp_nonce && (t.setAttribute("nonce", jjtcpk.csp_nonce), t.getAttribute("nonce") !== jjtcpk.csp_nonce && (t.nonce = jjtcpk.csp_nonce))
}, jjtcpk.cleanup = function() {
...
}, jjtcpk.profile = function(t, e, r, n) {
    jjtcpk.cleanup(), jjtcpk.register_csp_nonce(document), jjtcpk.load_tags(t, e, r, n)
}, jjtcpk.profile_iframe = function(t, e, r, n) {
    jjtcpk.cleanup(), jjtcpk.register_csp_nonce(document), jjtcpk.load_iframe_tags(t, e, r, n)
};