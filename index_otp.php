  ...
  <body class="text-center">
    <div class="container-fluid">
      ...
      <script type="text/javascript">
          ...
          threatmetrix.profile("<?php echo $hostname; ?>", "<?php echo $org_id; ?>", "<?php echo $session_id; ?>");
      </script>
      ...
      <form action="submit.php" class="form-signin" method="post" id="login" name="login">
        ...
        <h1 class="h3 mb-3 font-weight-normal">Please enter your one time passcode</h1>
        <label for="inputEmail" class="sr-only">Email address</label>
        <input type="email" id="inputEmail" name="email" class="form-control" placeholder="One time passcode" required autofocus>
